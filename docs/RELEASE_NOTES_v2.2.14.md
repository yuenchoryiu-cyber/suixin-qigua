...
Pip-Boy 风格桌面起卦 · 梅花 / 六爻 / 奇门 · 自带多模型一键预设

### Highlights
- 开始页易经字雨 + 随机卦象金句
- 占卜体系：梅花易数 / 六爻纳甲 / 奇门遁甲 / **随机起卦**
- 取数：时间 · 数字 · 地理 · 天气 · 颜色 · 随机
- 今日吉凶（一天一次）与多维 bar 评分分享卡
- DeepSeek / 豆包 / Claude / OpenAI / Kimi / 通义 / 智谱等一键接入
- 分享图默认脱敏，不含 API Key；分享卡支持数字雨背景
- **应用内更新（安装版）**：启动检测 → 下载更新包 → 打开后仅静默更新程序（可跳版本直达最新）
- 完整 Setup 安装前自动结束旧进程，避免与正在运行的程序冲突

### What’s new
- Windows / macOS 同步发布
- 修复「降级更新」误报（如已装更高版本却提示 2.2.4）
- 仅当远端版本严格更新时才弹出更新框
- 高精度意图细化与追问（API）
...
| Platform | File |
|----------|------|
| Windows 安装 | `suixin-qigua-2.2.14-win-x64.exe` |
| Windows 便携 | `suixin-qigua-2.2.14-win-portable.exe` |
| macOS | `suixin-qigua-2.2.14-mac-universal.dmg` |
| macOS (zip) | `suixin-qigua-2.2.14-mac-universal.zip` |

Mac 未签名，首次打开可在「隐私与安全性」允许。  
便携版 / 直接拖进 Applications 的 zip 不走应用内差量更新；Windows 需要自动更新请用「安装」包。

### Update tip（已安装用户 · Windows）
1. 打开已安装的随心起卦（安装版）
2. 若提示新版本：点 **下载更新包** → **打开更新包（仅更新程序）**
3. 程序将静默更新并重开
